...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React3.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React3.useEffect(() => {
  ...
  const updateRootElementName = React3.useCallback((instance) => {
...
//# sourceMappingURL=chunk-J6Q4YSWN.js.map
