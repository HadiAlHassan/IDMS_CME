...
function createGrid(options = {}) {
  ...
  const Grid2 = React13.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime10.jsx)(GridRoot, _extends({
      ...
      children: React13.Children.map(children2, (child) => {
...
function joinChildren(children2, separator) {
  const childrenArray = React14.Children.toArray(children2).filter(Boolean);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LETLEFH5.js.map
