...
scraper.scrape("https://www.courtlistener.com/opinion/97635/graham-v-west-virginia/?q=graham&type=o&order_by=score%20desc&stat_Precedential=on")
print("---------------------------------------------------")
scraper.scrape("https://www.courtlistener.com/opinion/2196810/onti-inc-v-integra-bank/?type=o&q=%2Conty&type=o&order_by=score%20desc&stat_Precedential=on")
print("---------------------------------------------------")
scraper.scrape("https://www.courtlistener.com/opinion/96015/adams-v-new-york/?type=o&q=&type=o&order_by=score%20desc&stat_Precedential=on")
print("---------------------------------------------------")
scraper.scrape("https://scholar.google.com/scholar_case?case=913703117340005992&q=state&hl=en&as_sdt=2006")
print("---------------------------------------------------")
scraper.scrape("https://harvardlawreview.org/blog/2023/09/reversing-remands-procedural-uncertainty-in-a-presidents-state-criminal-trials/")
print("---------------------------------------------------")
scraper.scrape("https://harvardlawreview.org/blog/2024/05/civil-suits-by-parents-against-family-policing-agencies/")
